var S = {
    init: function() {
        ...
        if (i !== -1) {
            ...
            S.UI.simulate('|#countdown 3||祝|牛|闯|生|日|快|乐||Happy|birthday|to|you|一起|不断|进步|鸭|#rectangle|');
        }
...
S.Drawing = (function() {
    ...
    return {
        ...
        adjustCanvas: function() {
            canvas.width = window.innerWidth; // 改变文字大小   原始不除
...
S.Dot = function(x, y) {
    ...
    this.c = new S.Color(255, 255, 255, this.p.a); //改变颜色
